...
class ProjectsWatcher {
    ...
    addProject(projectConfig) {
        debugTools_1.debugLog("Creating project compiler for:", projectConfig.projectPath);
        const newProjectCompiler = new Project_1.Project(projectConfig, this.projectCompilationStart, this.projectCompilationComplete, this.projectCompilationFinal);
